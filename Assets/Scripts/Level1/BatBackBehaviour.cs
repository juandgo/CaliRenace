...
public class BatBackBehaviour : StateMachineBehaviour
{
    ...
    {
        batFollow = animator.GetComponent<BatFollow>();
        initialPoint = batFollow.initialPoint;
    }
